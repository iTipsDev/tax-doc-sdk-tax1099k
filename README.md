# tax-doc-sdk-tax1099k

Software development kit to generate IRS Form 1099-K as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099K.sample.png" width="850"/>
