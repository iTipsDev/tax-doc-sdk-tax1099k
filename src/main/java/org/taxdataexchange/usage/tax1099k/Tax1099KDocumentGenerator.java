...
import irs.fdxtax641.jsonserializers.Tax1099KSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099K;
import org.taxdataexchange.core.pdfbuilders.Tax1099KPdfBuilder;
...
public class Tax1099KDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099K obj = Map2Tax1099K.generate( row );
        {
            String asJson = Tax1099KSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099K.csv";
        ...
        String outputFileName = "Tax1099K.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099KDocumentGenerator generator = new Tax1099KDocumentGenerator( );
